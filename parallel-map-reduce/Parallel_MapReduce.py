...
if (__name__ == '__main__'):
    ...
    # Create a pool of threads with the number of CPUs.
    pool = Pool(cpu_count())
    ...
    mapped = pool.map(mapChunks, dataChunks)
    ...
    print("\nIt took %s seconds to execute the parallel MapReduce algorithm." % (time.time() - startTime))
    ...
    # Print how long it took.
    print("\nIt took %s seconds to execute the parallel MapReduce program." % (time.time() - startTime))
